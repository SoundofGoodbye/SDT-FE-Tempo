...
import { getUserEmail, apiClient } from "@delivery-system/api-client";
...
export const ProductListImportModal: React.FC<ProductListImportModalProps> = ({
  ...
  const handleImport = async () => {
    ...
    try {
      const result = await apiClient.postForm<ImportResponse>(
          `company/${companyId}/shops/${shopId}/product-lists/import/file`,
          formData
      );

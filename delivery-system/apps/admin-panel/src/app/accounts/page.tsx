  ...
  return (
      <div className="bg-background p-6 md:p-8 w-full min-h-screen">
            ...
            <CardContent>
              <div className="flex items-center">
                ...
                <div className="text-2xl font-bold">
                  {isAdmin ? stats.admins : stats.managers}
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <CardContent>
            <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between mb-6">
              <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center flex-1">
                ...
                <Select
                    value={filters.role}
                    onValueChange={(value: typeof filters.role) => updateFilters({ role: value })}
                >
                ...
                <Select
                    ...
                    onValueChange={(value: string) => {
                      const [field, direction] = value.split("-") as [typeof sortOption.field, "asc" | "desc"];
        ...
        <AccountFormModal
            ...
            userRole={isAdmin ? "admin" : "manager"}
            assignedCompanyId={assignedCompanyId || userCompanyId?.toString()}
        />
      </div>
  );
}
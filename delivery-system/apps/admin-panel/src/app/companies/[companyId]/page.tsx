...
export default function CompanyDetailPage() {
  ...
  useEffect(() => {
    ...
    const assignedId = localStorage.getItem("assignedCompanyId");
    setUserRole(role);
    setAssignedCompanyId(assignedId);
    setIsLoading(false);
  }, []);
  ...
  if (userRole === "manager" && assignedCompanyId !== companyId) {
    return (
      <ForbiddenPage
        title="Access Denied"
      ...
      <div className="bg-background p-6 md:p-8 w-full min-h-screen">
        <Card>
          <CardContent className="flex flex-col items-center justify-center py-12">
            ...
            <Link href={userRole === "admin" ? "/companies" : "/insights"}>

//delivery-system/apps/admin-panel/src/app/companies/page.tsx
"use client";
...
export default function CompaniesPage() {
  ...
  useEffect(() => {
    ...
    if (isManager && userCompanyId) {
      router.push(`/companies/${userCompanyId}`);
    }
  }, [isManager, userCompanyId, router]);

  // Only admins can view the companies list
  if (!isAdmin) {
    return (
        <ForbiddenPage
